...
public class QuestionManagementServiceTests {
    ...
    private static QuestionRepository questionRepository = repositoryFactory.createQuestionRepository();
    ...
    static {
        ...
        questionRepository.save(new Question(1, 1, "Title1", "Question 1 text",
                ...
                Arrays.asList(new Tag(1, "Tag1"), new Tag(2, "Tag2"))));
        questionRepository.save(new Question(2, 1, "Title2", "Question 2 text",
                new Timestamp(System.currentTimeMillis()),
                Arrays.asList(new Tag(1, "Tag1"), new Tag(4, "Tag4"))));
    }
    ...
    public void addQuestionTest() {
        ...
        questionRepository.save(new Question(123, 1, "Title123", "Question 123 text",
                new Timestamp(System.currentTimeMillis()),
                Arrays.asList(new Tag(1, "Tag1"), new Tag(2, "Tag2"), new Tag(3, "Tag3"))));
